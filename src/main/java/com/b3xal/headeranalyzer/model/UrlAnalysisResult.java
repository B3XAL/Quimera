...
public class UrlAnalysisResult {
    ...
    /** Exact exchanges produced by a multi-endpoint active validation, in display order. */
    public List<HttpRequestResponse> probeExchanges = List.of();
    /** Human-readable service labels matching {@link #probeExchanges}. */
    public List<String> probeExchangeLabels = List.of();
    ...
    public UrlAnalysisResult withExtraFindings(List<HeaderFinding> extra) {
        ...
        copy.probeExchanges = this.probeExchanges;
        copy.probeExchangeLabels = this.probeExchangeLabels;
        return copy;
    }
