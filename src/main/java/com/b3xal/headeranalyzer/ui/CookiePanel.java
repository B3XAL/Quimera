...
public final class CookiePanel extends JPanel {
    ...
    private void ingestAuthTokens(UrlAnalysisResult result, String key) {
        // Group this response's Category.AUTH findings by (headerName, headerValue), every finding
        ...
        for (HeaderFinding f : result.findings) {
            if (f.category != HeaderFinding.Category.AUTH || f.headerValue == null) continue;
